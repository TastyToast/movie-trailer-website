...
mad_max = media.Movie(
  ...
  might be able to restore order: Max, a man of action and of few words, and \
  Furiosa, a woman of action who is looking to make it back to her childhood \
  homeland.",
  "120min",
...
ex_machina = media.Movie(
  ...
  experiment in artificial intelligence by evaluating the human qualities of \
